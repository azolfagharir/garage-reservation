...
const SERVICES = [
  { id: 1, name: "تعویض روغن" },
  { id: 2, name: "تنظیم موتور" },
  { id: 3, name: "تعویض لنت ترمز" },
  { id: 4, name: "شارژ کولر" },
  { id: 5, name: "تعویض فیلتر هوا" },
  { id: 6, name: "دیاگ خودرو" },
  { id: 7, name: "تعویض شمع" },
  { id: 8, name: "تعویض تسمه تایم" },
  { id: 9, name: "بالانس چرخ" },
